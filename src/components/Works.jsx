...
const Works = () => {
  return (
    <div className="works px-20  py-24 flex h-[90vh] gap-x-10 dark:bg-slate-800  ">
      ...
      <div className=" w-right relative">
        <motion.div
          ...
          className="w-mainCircle left-[9rem] relative w-[22rem] h-[22rem] rounded-full shadow-2xl top-[2rem] bg-white"
        >
